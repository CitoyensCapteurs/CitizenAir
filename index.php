...
<html lang="fr">
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="map" <?php if(!empty($live)) { echo 'class="live"'; }?>>
                <div id="live"></div>
            </div>
        </div>
        <footer id="footer" class="white-links">
            <p class='left'><?php if(empty($live)) { echo '<a href="#legend" onclick="event.preventDefault(); toggle(\'legend\', false);">Légende</a> | <a href="">Capteur en live</a>'; } else { echo '<a href="#legend" onclick="event.preventDefault(); toggle(\'legend\', false);">Choix du capteur</a> | <a href="index.php">Retour à la carte</a>'; }?> | <a href="">À propos</a></p>
            <p id="attribution"><?php if(empty($live)) { ?><a title="A JS library for interactive maps" href="http://leafletjs.com">Leaflet</a> | Map tiles by <a href="http://stamen.com">Stamen Design</a>, under <a href="http://creativecommons.org/licenses/by/3.0">CC BY 3.0</a>. Data by <a href="http://openstreetmap.org">OpenStreetMap</a>, under <a href="http://creativecommons.org/licenses/by-sa/3.0">CC BY SA</a> | <?php } ?><a href="http://www.citoyenscapteurs.net/">Citoyens Capteurs</a></p>
        </footer>
