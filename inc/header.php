<?php
    ...
    $tpl = "<!doctype html>
                <html lang=\"fr\">
                    ...
                    <body>
                        <header id=\"title\">
                            <p class='left'>".((!isset($_GET['live'])) ? '<a href="#legend" onclick="event.preventDefault(); toggle(\'legend\', false);">Légende</a> | <a href="?live=">Capteur en live</a>' : '<a href="#legend" onclick="event.preventDefault(); toggle(\'legend\', false);">Choix du capteur</a> | <a href="index.php">Retour à la carte</a>')." | <a href=\"about.php\">À propos</a></p>
