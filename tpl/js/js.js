...
window.onresize = function() {
    ...
    window.m.style.height = Math.max(document.documentElement.clientHeight, window.innerHeight || 0) - header_footer_size - Math.max(document.getElementById('svg_holder').offsetHeight, document.getElementById('svg_holder').clientHeight || 0)+ 'px';
...
window.onload = function() {
    ...
    SVG.init({'id': 'svg_holder', 'height': '100%', 'width': '100%', 'grid': 'both', 'x_axis': true, 'rounded': false, 'x_callback': false});
